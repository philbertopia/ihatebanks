---
slug: wheel-d20-c30
title: Wheel D20 C30 Explainer
summary: >-
  Wheel D20 C30 Explainer covers setup rules, entries, exits, and failure modes
  for educational use.
...
references:
  - title: tastylive options education channel
    ...
    source: youtube
    why_it_matters: 'Practical, trade-focused context for Wheel D20 C30 Explainer.'
...
strategy_key: stock_replacement|wheel_d20_c30
setup_rules:
