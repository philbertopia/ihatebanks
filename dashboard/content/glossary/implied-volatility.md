...
summary: >-
  Implied Volatility is a core options concept used in strategy setup, risk
...
references:
  - title: tastylive options education channel
    ...
    source: youtube
    why_it_matters: 'Practical, trade-focused context for Implied Volatility.'
...
---
## Definition
Implied Volatility describes a concept that appears repeatedly in trade selection and risk management.
