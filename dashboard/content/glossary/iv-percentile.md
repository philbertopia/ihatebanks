...
title: IV Percentile
summary: >-
  IV Percentile is a core options concept used in strategy setup, risk control,
...
references:
  - title: tastylive options education channel
    ...
    source: youtube
    why_it_matters: 'Practical, trade-focused context for IV Percentile.'
...
---
## Definition
IV Percentile describes a concept that appears repeatedly in trade selection and risk management.
