...
title: Drawdown
summary: >-
  Drawdown is a core options concept used in strategy setup, risk control, and
...
references:
  - title: tastylive options education channel
    ...
    source: youtube
    why_it_matters: 'Practical, trade-focused context for Drawdown.'
...
---
## Definition
Drawdown describes a concept that appears repeatedly in trade selection and risk management.
