...
summary: >-
  Cash Secured Put is a core options concept used in strategy setup, risk
...
references:
  - title: tastylive options education channel
    ...
    source: youtube
    why_it_matters: 'Practical, trade-focused context for Cash Secured Put.'
...
---
## Definition
Cash Secured Put describes a concept that appears repeatedly in trade selection and risk management.
